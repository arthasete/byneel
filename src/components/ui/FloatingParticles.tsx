  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
      ...
      <div className="floating-element" style={{ top: '5%', left: '8%', animationDelay: '0s', animationDuration: '22s' }}>
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" className="opacity-[0.25]">
      ...
      <div className="floating-element" style={{ top: '8%', right: '15%', animationDelay: '3s', animationDuration: '19s' }}>
        <span className="text-4xl font-mono opacity-[0.22] text-cyan select-none">&#123;&#125;</span>
      </div>

      {/* Binary stream */}
      <div className="floating-element" style={{ top: '12%', left: '45%', animationDelay: '7s', animationDuration: '25s' }}>
        <span className="text-sm font-mono opacity-[0.20] text-brand-blue select-none tracking-widest">10110011</span>
      </div>

      {/* Hashtag */}
      <div className="floating-element" style={{ top: '3%', right: '35%', animationDelay: '2s', animationDuration: '18s' }}>
        <span className="text-3xl font-mono opacity-[0.22] text-pink select-none">#</span>
      </div>
      ...
      <div className="floating-element" style={{ top: '28%', left: '3%', animationDelay: '1s', animationDuration: '24s' }}>
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" className="opacity-[0.24]">
      ...
      <div className="floating-element" style={{ top: '32%', right: '6%', animationDelay: '5s', animationDuration: '20s' }}>
        <span className="text-3xl font-mono opacity-[0.24] text-brand-blue select-none">&lt;/&gt;</span>
      </div>

      {/* Lambda */}
      <div className="floating-element" style={{ top: '38%', left: '88%', animationDelay: '9s', animationDuration: '21s' }}>
        <span className="text-4xl font-mono opacity-[0.22] text-brand-violet select-none">λ</span>
      </div>

      {/* Semicolon */}
      <div className="floating-element" style={{ top: '25%', left: '55%', animationDelay: '4s', animationDuration: '17s' }}>
        <span className="text-5xl font-mono opacity-[0.20] text-cyan select-none">;</span>
      </div>

      {/* Neural network node */}
      <div className="floating-element" style={{ top: '35%', left: '20%', animationDelay: '6s', animationDuration: '23s' }}>
        <svg width="38" height="38" viewBox="0 0 24 24" fill="none" className="opacity-[0.22]">
      ...
      <div className="floating-element" style={{ top: '55%', right: '10%', animationDelay: '8s', animationDuration: '16s' }}>
        <span className="text-2xl font-mono opacity-[0.24] text-cyan select-none">$_</span>
      </div>

      {/* AI Brain hemisphere */}
      <div className="floating-element" style={{ top: '52%', left: '5%', animationDelay: '4s', animationDuration: '22s' }}>
        <svg width="44" height="44" viewBox="0 0 24 24" fill="none" className="opacity-[0.24]">
      ...
      <div className="floating-element" style={{ top: '60%', right: '40%', animationDelay: '11s', animationDuration: '26s' }}>
        <span className="text-sm font-mono opacity-[0.20] text-brand-blue select-none tracking-wider">01101</span>
      </div>

      {/* Pipe operator */}
      <div className="floating-element" style={{ top: '65%', left: '75%', animationDelay: '3s', animationDuration: '19s' }}>
        <span className="text-4xl font-mono opacity-[0.22] text-pink select-none">|&gt;</span>
      </div>

      {/* Arrow function */}
      <div className="floating-element" style={{ top: '58%', left: '35%', animationDelay: '10s', animationDuration: '20s' }}>
        <span className="text-3xl font-mono opacity-[0.22] text-brand-violet select-none">=&gt;</span>
      </div>

      {/* Database icon */}
      <div className="floating-element" style={{ top: '68%', left: '12%', animationDelay: '7s', animationDuration: '23s' }}>
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="opacity-[0.22]">
      ...
      <div className="floating-element" style={{ top: '78%', right: '8%', animationDelay: '2s', animationDuration: '21s' }}>
        <svg width="34" height="34" viewBox="0 0 24 24" fill="none" className="opacity-[0.22]">
      ...
      <div className="floating-element" style={{ top: '82%', left: '25%', animationDelay: '5s', animationDuration: '18s' }}>
        <span className="text-4xl opacity-[0.22] text-brand-violet select-none">∞</span>
      </div>

      {/* Brackets */}
      <div className="floating-element" style={{ top: '88%', right: '30%', animationDelay: '9s', animationDuration: '24s' }}>
        <span className="text-3xl font-mono opacity-[0.20] text-brand-blue select-none">[ ]</span>
      </div>

      {/* Atom/React icon */}
      <div className="floating-element" style={{ top: '75%', left: '60%', animationDelay: '1s', animationDuration: '20s' }}>
        <span className="text-3xl opacity-[0.24] text-cyan select-none">⚛</span>
      </div>

      {/* Function */}
      <div className="floating-element" style={{ top: '92%', left: '8%', animationDelay: '6s', animationDuration: '17s' }}>
        <span className="text-2xl font-mono opacity-[0.22] text-pink select-none">fn()</span>
      </div>

      {/* Angle brackets */}
      <div className="floating-element" style={{ top: '85%', right: '55%', animationDelay: '12s', animationDuration: '22s' }}>
        <span className="text-2xl font-mono opacity-[0.20] text-brand-violet select-none">&lt;T&gt;</span>
      </div>
      ...
      {/* Geometric shapes — borders only, more visible */}
      <div className="geo-shape" style={{ top: '15%', left: '8%', width: '90px', height: '90px', borderColor: 'rgba(59,130,246,0.24)', borderRadius: '20px', animation: 'geo-spin 30s linear infinite' }} />
      <div className="geo-shape" style={{ top: '45%', right: '5%', width: '70px', height: '70px', borderColor: 'rgba(236,72,153,0.22)', borderRadius: '12px', animation: 'geo-spin 25s linear infinite reverse' }} />
      <div className="geo-shape" style={{ top: '70%', left: '15%', width: '60px', height: '60px', borderColor: 'rgba(6,182,212,0.22)', borderRadius: '50%', animation: 'geo-spin 35s linear infinite' }} />
      <div className="geo-shape" style={{ top: '90%', right: '20%', width: '80px', height: '80px', borderColor: 'rgba(139,92,246,0.20)', borderRadius: '16px', animation: 'geo-spin 28s linear infinite reverse' }} />
    </div>
  );
}
